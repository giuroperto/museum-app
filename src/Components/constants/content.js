...
const CONTENT = {
  ...
  ACHIROPITA_HISTORIA_3:{
    ...
    ACHIROPITA_PAROQUIA_SEMENTEIRA: {
    ...
    ACHIROPITA_PAROQUIA_CONGREGACAO: {
    ...
    ACHIROPITA_PAROQUIA_PASTORAL_22: {
      ...
      type: "pdf",
      text: PDFS.ACHIROPITA_PAROQUIA_PASTORAL_22,
      images: []
    },
    ACHIROPITA_FESTA: {
